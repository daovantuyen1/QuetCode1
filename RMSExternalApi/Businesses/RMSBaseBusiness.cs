                 ...
                 .Query(
                        $@"
                          SELECT 
                                    ...
                                    A.EXPERIENCE ,
                                    A.QTY ,
                                    TO_CHAR( DECODE(A.UPDATE_TIME,NULL,A.CREATE_TIME,A.UPDATE_TIME ) , :FORMARTDT ) AS UPDATE_TIME,
                                    A.SALARY ,
                                    A.IS_HOTJOB  ,
                                    B.VN_DESC,
                                    B.EN_DESC, 
                                    ...
                                    AND A.STATUS='Public' 
                                    AND A.IS_DELETE='N' 
                                    AND (  A.COUNTRY IN :COUNTRYLS
                                           OR   A.LANGUAGE_ID LIKE  :LANGUAGE_ID     )
                                    AND A.RECRUITMENT_NAME= :RECRUITMENT_NAME
                                    AND ROWNUM<= 8
                                    ORDER BY  TO_CHAR( DECODE(A.UPDATE_TIME,NULL,A.CREATE_TIME,A.UPDATE_TIME ) , :FORMARTDT )   DESC
                        "
                        ,
                             new
                             {
